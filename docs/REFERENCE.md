...
Upstream technical reference, extracted verbatim from CLAUDE.md so the always-hot context file stays inside its 12,000 character budget. Nothing here was reworded or shortened.

## 2026-07-26: upstream technical reference moved out of CLAUDE.md
